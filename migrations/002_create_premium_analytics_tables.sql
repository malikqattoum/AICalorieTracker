...
CREATE TABLE IF NOT EXISTS health_reports (
    ...
    generated_by ENUM('user', 'system', 'professional') DEFAULT 'system',
...
CREATE TABLE IF NOT EXISTS health_goals (
    ...
    achievement_probability DECIMAL(5,2) DEFAULT 50,
    milestones JSON,
...
CREATE TABLE IF NOT EXISTS health_insights (
    id INT AUTO_INCREMENT PRIMARY KEY,
    user_id INT NOT NULL,
    insight_type ENUM('pattern', 'anomaly', 'recommendation', 'achievement', 'warning') NOT NULL,
    category VARCHAR(50),
