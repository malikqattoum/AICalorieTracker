    ...
    <div className="flex flex-col min-h-screen">
              ...
              <div className="relative w-full max-w-lg">
                ...
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden p-1 relative">
                  ...
                  <div className="absolute top-4 right-4 bg-white rounded-xl shadow-lg p-3">
                    ...
                    <div className="text-2xl font-bold text-primary">{hero.calories}</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((f: any, i: number) => (
              <div className="bg-neutral-50 p-6 rounded-xl" key={i}>
                <div className="bg-primary-100 w-14 h-14 rounded-lg flex items-center justify-center mb-4">
                  {f.icon === "Camera" && <Camera className="h-7 w-7 text-primary-600" />}
                  {f.icon === "Zap" && <Zap className="h-7 w-7 text-primary-600" />}
                  {f.icon === "LineChart" && <LineChart className="h-7 w-7 text-primary-600" />}
                </div>
          ...
          <div className="bg-primary-600 rounded-2xl p-8 md:p-12 overflow-hidden relative">
            ...
            <div className="relative">
              <div className="text-center max-w-3xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold mb-4 text-neutral-900">{loading ? "Loading..." : pricingCta.title}</h2>
                <p className="text-lg mb-8 text-neutral-600">{loading ? "" : pricingCta.subtitle}</p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {testimonials.map((t: any, i: number) => (
              <div className="bg-neutral-50 p-6 rounded-xl" key={i}>
                ...
                <p className="text-neutral-600">"{t.quote}"</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-neutral-900 mb-4">{finalCta.title}</h2>
          <p className="text-lg text-neutral-600 mb-8">{finalCta.subtitle}</p>
          <Link href="/auth">
