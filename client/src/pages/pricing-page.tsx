        ...
        <section className="bg-gradient-to-b from-primary-50 to-white py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg text-neutral-600 mb-8 max-w-2xl mx-auto">
              Choose the plan that fits your nutrition tracking needs.
              All plans include our core AI-powered food analysis technology.
            </p>
              ...
              {tiers.map((tier) => (
                <Card key={tier.id} className={`border ${tier.featured ? 'border-primary-500 ring-1 ring-primary-500' : 'border-neutral-200'} overflow-hidden`}>
                  ...
                  <CardContent className="p-6">
                    <div className="mb-6">
                      <span className="text-4xl font-bold text-neutral-900">{billingInterval === "monthly" ? tier.price.monthly : tier.price.yearly}</span>
                  ...
                  <CardFooter className="bg-neutral-50 px-6 py-4">
                    <Link href={tier.href} className="w-full">
                      <Button 
                        className={`w-full ${tier.featured ? 'bg-primary-600 hover:bg-primary-700' : ''}`}
